...
local request, request2 = lib.Network.Invoke("Bank Deposit", mybanks[1]['BUID'], PetsList, 1000000000);
if lib.Network.Invoke("Bank Deposit", mybanks[1]['BUID'], PetsList, 1000000000) then
